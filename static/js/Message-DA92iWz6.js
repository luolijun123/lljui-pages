var B=Object.defineProperty;var d=Object.getOwnPropertySymbols;var L=Object.prototype.hasOwnProperty,_=Object.prototype.propertyIsEnumerable;var m=(p,s,t)=>s in p?B(p,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):p[s]=t,g=(p,s)=>{for(var t in s||(s={}))L.call(s,t)&&m(p,t,s[t]);if(d)for(var t of d(s))_.call(s,t)&&m(p,t,s[t]);return p};import{M as v}from"./MainWrap-BDguTXp5.js";import{C as y}from"./index-BQfoAbTe.js";import{m as b}from"./index-Dj1loc-8.js";import{r as P,I as w,o as S,v as C,z as o,f as i,g as n,J as a,t as h,u as r}from"./chunks/@vue-k1McLpBC.js";import"./chunks/prismjs-q4AeMOAZ.js";import"./chunks/nprogress-BoRHhhMm.js";import"./chunks/vue-router-QhFutdZn.js";const M={class:"Block",id:"Messsage-Type"},F=i("p",{class:"Title"},"组件使用",-1),j=i("span",{class:"Desc"}," 引入组件的方式使用 ",-1),V=i("div",{class:"Preview-Block"}," 类型 ",-1),T={class:"Preview-Block"},q=i("div",{class:"Preview-Block"}," 停留时间 ",-1),x={class:"Preview-Block"},D=i("div",{class:"Preview-Block"}," 加载 ",-1),N={class:"Preview-Block"},E={class:"Block",id:"Messsage-Fn"},O=i("p",{class:"Title"},"函数调用",-1),z=i("span",{class:"Desc"}," 使用函数的形式调用 ",-1),I=i("div",{class:"Preview-Block"}," 类型 ",-1),J={class:"Preview-Block"},X={__name:"Message",setup(p){const s=P({show:!1,type:"info",closeable:!1,duration:3e3,message:"操作成功！"}),t=c=>{s.show=!0,s.closeable=!1,s.duration=3e3,Object.keys(c).forEach(e=>{s[e]=c[e]})},u=c=>{s.show=!1,b(g({type:"info",closeable:!1,duration:3e3,message:"操作成功！"},c))};return(c,e)=>{const l=w("LButton"),f=w("LMessage");return S(),C(v,{list:[{id:"Messsage-Type",label:"组件使用"},{id:"Messsage-Fn",label:"函数调用"}]},{default:o(()=>[i("div",M,[F,j,n(y,{codes:`    <!-- script -->
    <script setup>
    ...
    <template>
      ...
      `},{default:o(()=>[I,i("div",J,[n(l,{type:"primary",onClick:e[8]||(e[8]=()=>{u({type:"info",message:"操作提示！"})})},{default:o(()=>[a("操作提示")]),_:1}),n(l,{type:"success",onClick:e[9]||(e[9]=()=>{u({type:"success",message:"操作成功！"})})},{default:o(()=>[a("操作成功")]),_:1}),n(l,{type:"warning",onClick:e[10]||(e[10]=()=>{u({type:"warning",message:"操作警告！"})})},{default:o(()=>[a("操作警告")]),_:1}),n(l,{type:"warning",onClick:e[11]||(e[11]=()=>{u({type:"question",message:"操作帮助！"})})},{default:o(()=>[a("操作帮助")]),_:1}),n(l,{type:"danger",onClick:e[12]||(e[12]=()=>{u({type:"danger",message:"操作严重后果！"})})},{default:o(()=>[a("操作严重后果")]),_:1})])]),_:1})]),n(f,{modelValue:r(s).show,"onUpdate:modelValue":e[13]||(e[13]=k=>r(s).show=k),duration:r(s).duration,type:r(s).type,closeable:r(s).closeable},{default:o(()=>[a(h(r(s).message),1)]),_:1},8,["modelValue","duration","type","closeable"])]),_:1})}}};export{X as default};
